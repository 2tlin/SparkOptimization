...
object ByKeyFunctions {
  ...
  val words: Seq[String] = Source.fromFile("src/main/resources/data/lipsum/words.txt")
    .getLines()
    .toSeq
  ...
  val wordCounts: RDD[(String, Int)] = sc.parallelize(Seq.fill(2000000)((words(random.nextInt(words.length)), random.nextInt(1000)))) // generate key-value pair
  ...
  */
  ...
  def main(args: Array[String]): Unit = {
    Thread.sleep(1000000) // about 20 minutes
  }
}
