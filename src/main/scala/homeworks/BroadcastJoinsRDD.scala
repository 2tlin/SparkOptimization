...
object BroadcastJoinsRDD {
  ...
  */
  ...
  val improvedMedalists: RDD[(String, String)] = leaderboard mapPartitions { iterator => // iterator of all the tuples in this partition; all the tuples are local to this executor
